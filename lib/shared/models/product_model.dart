...
class SampleData {
  static List<ProductModel> wishlistProducts = [
    const ProductModel(
      ...
      imageUrl: 'assets/item/Voltaren.jpg',
      price: 6.50,
      unit: '20 Caplets',
    ...
    const ProductModel(
      ...
      imageUrl: 'assets/item/Telfast_180mg_10_Tablets_1000x.webp',
      price: 8.99,
      unit: '24 Tablets',
      category: 'Pain Relief',
      isWishlisted: true,
    ...
    const ProductModel(
      ...
      imageUrl: 'assets/item/swisse_mens_ultivite.webp',
      price: 15.50,
      unit: '16 Lozenges',
      category: 'Cold & Flu',
      isWishlisted: true,
    ...
    const ProductModel(
      ...
      imageUrl: 'assets/item/Blackmores.jpg',
      price: 49.99,
      unit: '30 Capsules',
      category: 'Vitamins',
      isWishlisted: true,
  ...
  static List<ProductModel> featuredProducts = [
    ...
    const ProductModel(
      ...
      imageUrl: 'assets/item/sudafed.webp',
      price: 18.50,
      unit: '24 Tablets',
      category: 'Cold & Flu',
    ...
    const ProductModel(
      ...
      imageUrl: 'assets/item/Amoxicillin.png',
      price: 0.00,
      unit: '20 Capsules',
