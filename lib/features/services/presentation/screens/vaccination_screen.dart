            ...
            Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  _buildSectionHeader('Booking Process'),
                  _stepItem('1', 'Select your required service'),
                  _stepItem('2', 'Check current eligibility and costs'),
                  _stepItem('3', 'Choose a convenient appointment time'),
                  _stepItem('4', 'Complete patient information'),
                  ...
                  const SizedBox(height: 16),
                  Text(
                    'Please bring identification and any relevant vaccination records to your appointment.',
